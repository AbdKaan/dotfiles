...
-- Auto import commands on save for go
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        'gofumpt', -- Used for formatting Go
        'goimports-reviser', -- Used for formatting go imports
        'golines', -- Used for formatting longer lines
        'staticcheck', -- linter for Go
        'stylua', -- Used to format Lua code
        'black', -- Python formatter
        'isort', -- Python formatter that sorts imports
        'mypy', -- Python linter
        'ruff', -- Python linter
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua', args = { '--call_parentheses', 'Always' } },
